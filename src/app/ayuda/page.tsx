...
export const metadata = {
  title: "Cómo obtener el token de Shopify — OptimoIA",
  description:
    "Guía paso a paso para crear una Custom App en Shopify y obtener el Admin API access token necesario para usar OptimoIA.",
}
    ...
    <div className="min-h-screen bg-[#f8fafc] text-[#0f172a]">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        ...
        <p className="mt-4 text-lg leading-relaxed text-[#475569]">
          OptimoIA necesita un <strong className="text-[#0f172a]">Admin API access token</strong> para
        ...
        <ol className="mt-10 flex flex-col gap-8">
          ...
          <li className="flex gap-5">
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#EC1E63] text-sm font-bold text-white">
              1
            </div>
          ...
          <li className="flex gap-5">
            ...
            <div className="pt-0.5">
              ...
              <p className="mt-1 text-[#475569]">
                ...
                nombre descriptivo (por ejemplo <em>OptimoIA Schema</em>) y confirma.
              </p>
            </div>
          </li>
              ...
              <ul className="mt-4 flex flex-col gap-2">
                {SCOPES.map(({ scope, desc }) => (
                  <li key={scope} className="flex items-start gap-3 rounded-lg border border-[#e2e8f0] bg-white px-4 py-3">
                    <code className="shrink-0 rounded bg-[#fdf2f6] px-2 py-0.5 text-xs font-semibold text-[#EC1E63]">
                      {scope}
                    </code>
          ...
          <li className="flex gap-5">
            ...
            <div className="pt-0.5">
              ...
              <p className="mt-1 text-[#475569]">
                ...
                para revelar el valor. El token empieza por <code className="rounded bg-[#fdf2f6] px-1.5 py-0.5 text-xs font-semibold text-[#EC1E63]">shpat_</code>.
                Cópialo y pégalo en OptimoIA.
              </p>
            </div>
          </li>
        </ol>
        ...
        <div className="mt-4 rounded-xl border border-[#e2e8f0] bg-white px-5 py-4">
          ...
          <p className="mt-1 text-sm text-[#475569]">
            OptimoIA <strong>no almacena tu token</strong>. Se envía directamente al motor de
        ...
        <div className="mt-10">
          <Link
            href="/app"
            className="inline-flex items-center gap-2 rounded-md bg-[#EC1E63] px-6 py-3 text-sm font-semibold text-white hover:bg-[#c4154f]"
          >
            Ir al panel →
          </Link>
        </div>

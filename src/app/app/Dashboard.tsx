        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <p className="text-xs text-[#64748b]">
              El token de acceso se obtiene automáticamente de tu{" "}
              <Link href="/app/shopify" className="text-[#EC1E63] hover:underline">
          ...
          <div className="flex flex-col gap-3">
            {jobs.map((job) => (
              ...
              >
                ...
                {job.status === "failed" && (
                  job.failureReason === "token_revoked" ? (
                    <div className="mt-3 rounded-lg border border-red-200 bg-red-50 px-4 py-3">
                      <p className="text-sm text-red-700">
                        La conexión con tu tienda ha caducado o fue revocada. Reconéctala para
                        seguir enriqueciendo.
                      </p>
                      <Link
                        href="/app/shopify"
                        className="mt-2 inline-block text-sm font-semibold text-[#EC1E63] hover:underline"
                      >
                        Reconectar tienda →
                      </Link>
                    </div>
